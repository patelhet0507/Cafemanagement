...
function ChartTooltipContent({
  ...
  formatter?: (value: number | string, name: string | number, item: ChartTooltipPayloadItem, index: number, payload: Record<string, unknown>) => React.ReactNode;
  hideLabel?: boolean;
                  ...
                  <>
                    ...
                    <div className={cn("flex flex-1 justify-between leading-none", nestLabel ? "items-end" : "items-center")}>
                      ...
                      {item.value !== undefined && (
                        <span className="text-foreground font-mono font-medium tabular-nums">{Number(item.value).toLocaleString("en-IN")}</span>
                      )}
                    </div>
                  </>
                )}
