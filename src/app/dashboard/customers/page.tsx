  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-4 bg-surface rounded-xl border border-border"><div className="flex items-center justify-between mb-2"><p className="text-xs text-text-muted">Total Customers</p><Users className="w-4 h-4 text-accent" /></div><p className="text-2xl font-semibold font-mono">{mockCustomers.length * 250}</p></div>
