...
import { VelocityMarquee, ScrollRevealText, Spotlight, Magnet } from "@/components/landing/scroll-fx";
  ...
  return (
    <div ref={rootRef} className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1">
        ...
        <VelocityMarquee
          items={["QR ORDERING", "LIVE KITCHEN", "RECIPE STOCK", "UPI PAYMENTS", "TABLE QR", "NO APP NEEDED"]}
        />

        {/* Feature strip — editorial, not 3 equal cards */}
        <section className="max-w-[1160px] mx-auto px-6 lg:px-8 py-12 lg:py-16">
          <ScrollRevealText
            text="One scan runs the whole cafe."
            className="font-display text-[28px] sm:text-[36px] font-semibold tracking-[-0.02em] leading-tight max-w-[20ch] mb-8"
          />
          <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-6">
            <Spotlight data-reveal className="rounded-[24px] border border-border bg-accent text-white p-7 sm:p-8 flex flex-col">
              ...
              <Link href="/scan" className="relative z-10 mt-6 inline-flex items-center gap-1.5 text-sm font-semibold text-white underline underline-offset-4 decoration-white/30 hover:decoration-white">Scan QR to order →</Link>
            </Spotlight>
            <div className="grid grid-rows-2 gap-6">
              <Spotlight data-reveal className="rounded-[24px] border border-border bg-surface p-7">
