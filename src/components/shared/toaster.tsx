  ...
  return (
    <Ctx.Provider value={show}>
      ...
      <div className="fixed bottom-4 right-4 z-[70] space-y-2">
        {toasts.map((t) => (
          <div key={t.id} className={`flex items-center gap-2.5 px-4 py-3 rounded-xl shadow-xl border text-sm font-medium min-w-[280px] ${t.type === "success" ? "bg-accent text-white border-success" : "bg-accent text-white border-error"}`}>
